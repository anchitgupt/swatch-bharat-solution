...
public class ChildFragment extends Fragment implements ValueEventListener {
    ...
    public static ChildFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // String type = getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER));
        FirebaseDatabase.getInstance().getReference().child("child").child("new").addValueEventListener(this);
