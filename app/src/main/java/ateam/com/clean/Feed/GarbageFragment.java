...
public class GarbageFragment extends Fragment implements ValueEventListener {
    ...
    public static GarbageFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // String type = getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER));
        FirebaseDatabase.getInstance().getReference().child("garbage").child("new").addValueEventListener(this);
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if(feedDataList.size() != 0) {
            Collections.reverse(feedDataList);
