...
public class PitFragment extends Fragment implements ValueEventListener {
    ...
    public static PitFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // String type = getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER));
        FirebaseDatabase.getInstance().getReference().child("pit").child("new").addValueEventListener(this);
