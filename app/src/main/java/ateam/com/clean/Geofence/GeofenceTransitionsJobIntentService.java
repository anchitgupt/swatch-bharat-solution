...
public class GeofenceTransitionsJobIntentService extends JobIntentService {
    ...
    protected void onHandleWork(Intent intent) {
        ...
        Log.e(TAG, "onHandleWork: "+String.valueOf(geofencingEvent.getTriggeringLocation().getLongitude()));
    ...
    private String getGeofenceTransitionDetails(
        ...
        Log.e(TAG, "getGeofenceTransitionDetails: "+geofenceTransitionString + ": " + triggeringGeofencesIdsString );
